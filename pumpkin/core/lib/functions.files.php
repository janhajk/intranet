...
//L�dt eine Datei herunter (rechtspr�fung wurde ist schon erfolgt
function downloadFile($id, $ext, $title, $path='') {
	$filename = $GLOBALS['ROOT_PATH'].'/files/'.$path.''.$id.'.'.$ext;
	$outname = $title.'.'.$ext;
	// F�r IE leerzeichen ersetzten durch '%20'
...
// Gibt Dateiname und Endung in einem Array zur�ck
...
// Z�hlt die Anzahl Zeilen in einem Verzeichnis und gibt Dateien und Ordner als Liste aus
...
// Z�hlt die Anzahl Zeilen in einem Verzeichnis
