...
class clsdb {
        ...
        function query($query) {
                ...
                if($this->db_status == "connected") {
                        if(!$this->result = mysql_query($query)) {
                                ...
                                if(substr($query, 0, 4) == "SELE") { $this->count = mysql_num_rows($this->result);
        ...
        function results() {
                ...
                if(!$this->result) {
						...
						//return mysql_error();
                        return mysql_fetch_array($this->result, $this->assoc);
                }
        }		
		...
		// m�chte man die `id`-Spalte weglassen, dann kann man $start = 1 setzten
