				...
				<table cellspacing="0" border="1" align="center">
					...
					foreach($a as $aa) { ?>
						<tr style="background-color:<?=$statuscolor[$aa['status']];?>">
							...
							<td><a href="<?=SITE_HTML;?>/actions.php?a=changeBillStatus&b=<?=$aa['id'];?>&s=<?=$aa['status'];?>"><img src="../images/icons/<?=getStatus($aa['status']);?>" border="0" title="<?=getVertragTitle($aa['vertrag']);?>" /></a></td>
